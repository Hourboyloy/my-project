...
function Weather() {
    ...
    useEffect(()=>{
      ...
      return (
        <div className="w-full h-28 2xl:h-24 rounded-lg flex justify-center items-center">
          <div className="w-full relative bg-gray-800 text-white text-sm md:text-lg rounded flex justify-center items-center space-x-4 px-3  h-full shadow shadow-black">
            ...
            <p>
              {Weather?.main?.temp}
              <span className=' absolute items-center justify-center top-13 text-sm'>°C</span>
            </p>
          </div>
        </div>
      );
