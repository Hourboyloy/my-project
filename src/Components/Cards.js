...
function Cards(props) {
  ...
  return (
    <div className=" bg-gray-900  p-4 space-y-3">
      {/* <div data-aos="fade-up" className=" grid grid-cols-5 gap-3">
        <div className="isHoverStyle w-full col col-span-2 h-72 overflow-hidden rounded-lg relative">
          <img
            src={require(`../images/for-slide/${arrayImage[currentIndex]}`)}
            className=" object-cover object-center transition-all duration-75"
            alt=""
          />
          <div className=" absolute bottom-0 text-slate-300 px-3 py-1 space-y-1">
            ...
            <div>
              <div className="text-gray-400 flex justify-between items-center">
                ...
                <div>
                  <ul className=" mr-6 flex items-center space-x-2 rounded-full bg-gray-800 py-1 px-2">
                    {arrayImage.length > 0 &&
                      arrayImage.map((e, i) => (
                        <li
        ...
        <div className="isHoverStyle bg-gray-800 h-72  w-full border-gray-900 rounded-lg  shadow-gray-600">
          <div className=" h-40 overflow-hidden relative">
            <img
              src={require(`../images/photo10.jpg`)}
            ...
            <div
              ...
              className="w-full h-full duration-75 rounded-lg transition-all items-center absolute hover:inset-0  hover:bg-gray-800  hover:bg-opacity-50 z-10 top-0"
            >
              <div
                className={`${
                  isHovered === -10
        ...
        <div className="isHoverStyle bg-gray-800 h-72  w-full border-gray-900 rounded-lg  shadow-gray-600">
          <div className=" h-40 overflow-hidden relative">
            ...
            <div
              ...
              onMouseLeave={handleMouseLeave}
              className="w-full h-full duration-75 transition-all rounded-lg items-center absolute hover:inset-0  hover:bg-gray-800  hover:bg-opacity-50 z-10 top-0"
            >
              <div
                className={`${
                  isHovered === -20
        ...
        <div className="isHoverStyle w-full h-72 cursor-pointer items-center space-x-1 flex flex-col text-white space-y-3 py-3 px-2 bg-gray-800 rounded-lg">
          <div className="w-full flex justify-between items-center">
            <div className=" flex items-center space-x-2">
              <img
                src={require(`../images/logo9.jpg`)}
                className="w-5 border h-5 rounded-full"
                alt=""
              />
              <span>Shopping</span>
          ...
          <div className=" h-52 overflow-hidden relative">
            <img
              src={require(`../images/photo12.avif`)}
              alt=""
